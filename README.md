...
=======
# Tugaas-Kuliah
>>>>>>> e6f1acd1936488a7dab8e1abd1eafbc2ed8e1992
Git Release Notes (Git-1.9.5-preview20150319)
...
See http://git-scm.com/ for further details about Git including ports to other operating systems. Git for Windows is currently hosted at https://msysgit.github.io/.
...
•	As Git for Windows is built without Python support, all Git commands requiring Python are not yet supported; namely: git p4, git remote-hg.
